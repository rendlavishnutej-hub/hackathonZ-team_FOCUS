-- ─────────────────────────────────────────────────────────────────────────────
-- Quiz Module Migration (SAFE RE-RUN VERSION)
...
drop policy if exists "Anyone can read subjects" on public.quiz_subjects;
...
drop policy if exists "Anyone can read topics" on public.quiz_topics;
...
drop policy if exists "Users can view their own files" on public.quiz_files;
create policy "Users can view their own files" on public.quiz_files
  for select using (auth.uid() = user_id);

drop policy if exists "Users can insert their own files" on public.quiz_files;
create policy "Users can insert their own files" on public.quiz_files
  for insert with check (auth.uid() = user_id);

drop policy if exists "Users can delete their own files" on public.quiz_files;
...
drop policy if exists "Anyone can read seeded questions" on public.quiz_questions;
create policy "Anyone can read seeded questions" on public.quiz_questions
  for select using (file_id is null);

drop policy if exists "Users can read their own file questions" on public.quiz_questions;
...
drop policy if exists "Users can insert questions for their own files" on public.quiz_questions;
...
drop policy if exists "Users can insert their own attempt answers" on public.quiz_attempt_answers;
...
-- ─────────────────────────────────────────────────────────────────────────────
-- Seed data (safe re-run with ON CONFLICT DO NOTHING)
-- ─────────────────────────────────────────────────────────────────────────────
